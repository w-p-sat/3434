                                ...
                                <div>
                                    <div class="poker-chip-container">
                                        ...
                                        <div class="chip-inlay">
                                            <div class="internal-animation-container"></div>
                                            <div class="main-glow"></div>
                                            <div class="sparkle" style="--i:0; --x:-0.5"></div>
                                            <div class="sparkle" style="--i:1; --x:0.3"></div>
                                            <div class="sparkle" style="--i:2; --x:0.8"></div>
                                            <div class="sparkle" style="--i:3; --x:-0.2"></div>
                                            <div class="sparkle" style="--i:4; --x:0.6"></div>
                                            <div class="sparkle" style="--i:5; --x:-0.7"></div>
                                            <div class="sparkle" style="--i:6; --x:0.4"></div>
